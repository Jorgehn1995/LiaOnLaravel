        ...
        <div class="topbar">
            ...
            <div class="topbar-left">
                <div class="text-center">
                    <a href="index.html" class="logo"><i class="mdi mdi-radar"></i> <span>{{Auth::User()->institucion->abr}}</span></a>
                </div>
            </div>
            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="{{route('logincheck')}}" class="waves-effect waves-primary"><i
                                        class="ti-home"></i><span> Inicio </span></a>
                        </li>

                        <li class="has_sub">
                            <a href="javascript:void(0);" class="waves-effect waves-primary"><i class="ti-user"></i> <span> Alumnos </span>
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li>
                                    <a href="{{route('alumnos.claves')}}">Asignar Seccion</a>
                                </li>
                                <li>
                                    <a href="#">Listados</a>
                                </li>
                        ...
                        <li class="has_sub">
                            <a href="javascript:void(0);" class="waves-effect waves-primary"><i
                                        class="ti-stats-up"></i><span> Reportes </span> <span class="menu-arrow"></span> </a>
                            <ul class="list-unstyled">
                                <li>
                        ...
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                ...
                                <ol class="breadcrumb float-right hide-phone">
                                    <li class="breadcrumb-item"><a href="{{route('logincheck')}}">{{Auth::User()->institucion->abr}}</a></li>
