...
<div class="col-md-12">
    ...
    <div class="card-box">
        ...
        <div class="row">
            <div class="col-md-12">
                <form method="POST" action="{{route('niveles.update',$item->idnivel)}}">
                    @csrf
                    {{ method_field('PUT') }}
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nombre" value="{{$item->nombre}}" placeholder="Ejem: Ciclo Básico">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="corto" class="control-label">Nombre Corto del Nivel</label>
                                <input type="text" class="form-control" name="corto" value="{{$item->corto}}" placeholder="Ejem: Básico">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="descripcion" id="" class="form-control" rows="5"  placeholder="Agregue una descripción al nivel educativo">{{$item->descripcion}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
