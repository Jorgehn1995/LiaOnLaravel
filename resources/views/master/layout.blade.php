                ...
                <div id="navigation">
                    ...
                    <ul class="navigation-menu">
                        ...
                        <li class="has-submenu">
                            ...
                            <ul class="submenu">
                                <li>
                                    <a href="../alumnos/">Perfiles Institucionales</a>
                                </li>
                                <li>
                                    <a href="../alumnos/">Alumnos</a>
                                </li>
                                <li>
                                    <a href="../listados/asignar.php">Profesores</a>
                                </li>
                                <li>
                                    <a href="../listados/">Padres</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-submenu">
                            <a href="#">
                                <i class="ti-clipboard"></i>Institucional</a>
                            <ul class="submenu">
                                <li>
                                    <a href="../notas/">Instituciones</a>
                                </li>
                                <li>
                                    <a href="../notas/grado.php">Niveles</a>
                                </li>
                                <li>
                                    <a href="../notas/cuadro.php">Grados</a>
                                </li>
                                <li>
                                    <a href="../notas/cp.php">Secciones</a>
                                </li>
                                <li>
